                    ...
                    <div class="card offset-2 mb-2" style="width: 26rem;">
                        <div class="col-sm-10">
                            <div class="card-body">
                                ...
                                <input wire:model='buktiPGI' accept="image/png, image/jpeg" type="file"
                                    id="buktiPGI"
                                    class="ring-a ring-inset ring-gray-300 bg-gray-100 text-gray-900 rounded block mb-4 mt-2  offset-0">
                                @if ($buktiPGI)
                                    <img class="img-thumbnail rounded float-start offset-2"
                                        style="width: 300px; height: 300px" src="{{ $buktiPGI->temporaryUrl() }}"
                                        alt="">
                                @endif
            ...
            <tbody>
                @foreach ($sdhout as $key => $value)
                    <tr>
                        ...
                        <td>
                            <a wire:click="edit({{ $value->trsID }}, '{{ $value->trans_type }}')"
                                class="btn btn-primary btn-sm">Upload PGI</a>
                        </td>
                    </tr>
                @endforeach
