<div>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="row">
            <div class="col-sm-2">
                <label for=""></label>
                <input type="text" class="form-control mb-3 w-100" placeholder="Search CARID / SO "
                    wire:model.live="katakunci">
            </div>
            <div class="col-sm-2">
                <label for=""></label>
                <input type="text" class="form-control mb-3 w-75" placeholder="Search Customer"
                    wire:model.live="katacust">
            </div>
            <div class="col-sm-2 ms-2">
                <label for="">Filter by Date Out From</label>
                <input type="date" id="tglout1" class="form-control  mb-3 w-75" wire:model.blur="tglout1"
                    max="{{ date('Y-m-d') }}">
            </div>
            <div class="col-sm-2 ms-2">
                <label for="">Filter by Date Out To</label>
                <input type="date" id="tglout2" class="form-control  mb-3 w-75" wire:model.blur="tglout2"
                    max="{{ date('Y-m-d') }}">
            </div>
            <div class="col-sm-2 ms-2">
                <label for="">Filter by Shift WB IN</label>
                <select class="form-control mb-3 w-100" wire:model.live="shift">
