<div>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="mb-0">Antrian Senin</h1>
        ...
        <table class="table table-striped table-hover align-middle">
            ...
            <tbody>
                @php
                    $totalkg = 0;
                @endphp
                @foreach ($antriansenin as $key => $value)
                    <tr>
                        <td class="text-center">{{ $antriansenin->firstItem() + $key }}</td>
                        <td>{{ $value->pendfNo }}</td>
                        <td>{{ $value->tglMuat }}</td>
            ...
            <tfoot class="table-light">
                <tr>
                    <td colspan="12" class="text-end fw-bold">Total Weight:</td>
