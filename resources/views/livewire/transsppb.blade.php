                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="mb-3 mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control w-50" wire:model="kontrakNo"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="mb-3 mt-3 row">
                        ...
                        <div class="mb-3 mt-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control w-50" wire:model="sppbQtyKg"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="mb-3 mt-3 row">
                            ...
                            <div class="col-sm-10">
                                @if ($itemType == 'FG-L')
                                    <input type="text" id="input" class="form-control w-50"
                                        wire:model="sppbQtyKarung" autocomplete="off" disabled>
                                @else
                                    <input type="text" id="input" class="form-control w-50"
                                        wire:model="sppbQtyKarung" autocomplete="off">
                                @endif
                            </div>
                        </div>
                ...
                <div class="my-3 p-3 bg-body rounded shadow-sm">
                    ...
                    <div class="pb-3 pt-3">
                        <input type="text" class="form-control mb-3 w-25"
                            placeholder="Search by SPPB No or Customer Name" wire:model.live="katakunci">
                    </div>
                    ...
                    <table class="table table-striped table-sortable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-ms-1 sort @if ($sortColumn == 'spmNo') {{ $sortDirection }} @endif"
                                    wire:click="sort('sppbNo')">No SPPB</th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'tglSpm') {{ $sortDirection }} @endif"
                                    wire:click="sort('tglSppb')">Tgl SPPB</th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'carID') {{ $sortDirection }} @endif"
                                    wire:click="sort('kontrakNo')">No Kontrak</th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'itemName') {{ $sortDirection }} @endif"
                                    wire:click="sort('itemName')">Nama Barang</th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'transpName') {{ $sortDirection }} @endif"
                                    wire:click="sort('custName')">Nama Customer </th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'qtyKg') {{ $sortDirection }} @endif"
                                    wire:click="sort('sppbQtyKg')">Qty Kg </th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'qtyKarung') {{ $sortDirection }} @endif"
                                    wire:click="sort('sppbQtyKarung')">Qty Karung </th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'qtyKg') {{ $sortDirection }} @endif"
                                    wire:click="sort('openQtyKg')">Open Qty Kg </th>
                                <th class="col-ms-1 sort desc @if ($sortColumn == 'qtyKarung') {{ $sortDirection }} @endif"
                                    wire:click="sort('openQtyKarung')">Open Qty Karung </th>
