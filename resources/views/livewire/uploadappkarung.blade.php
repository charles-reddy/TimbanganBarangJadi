        ...
        <form>
                        ...
                        <div class="card-body offset-2">
                            <div class="mb-3 mt-3 row ">
                                <div class="card mr-2" style="width: 26rem;">
                                    <div class="col-sm-10">
                                        <div class="card-body">
                                            <label  class="col-sm-8 col-form-label offset-2">Bukti Cek ulang 1</label>
                                                <input wire:model='buktiAppKarung1' accept="image/png, image/jpeg" type="file" id="buktiAppKarung1"  class="ring-a ring-inset ring-gray-300 bg-gray-100 text-gray-900 rounded block mb-4 mt-2  offset-0">
                                                @if($buktiAppKarung1)
                                                    <img class="img-thumbnail rounded float-start offset-2" style="width: 300px; height: 300px" src="{{ $buktiAppKarung1->temporaryUrl() }}" alt="">
                                                @endif
                                                <div wire:loading wire:target="buktiAppKarung1">
                                ...
                                <div class="card mr-2" style="width: 26rem;">
                                    <div class="col-sm-10">
                                        <div class="card-body">
                                            <label  class="col-sm-8 col-form-label offset-2">Bukti Cek ulang 2</label>
                                                <input wire:model='buktiAppKarung2' accept="image/png, image/jpeg" type="file" id="buktiAppKarung2"  class="ring-a ring-inset ring-gray-300 bg-gray-100 text-gray-900 rounded block mb-4 mt-2  offset-0">
                                                @if($buktiAppKarung2)
                                                    <img class="img-thumbnail rounded float-start offset-2" style="width: 300px; height: 300px" src="{{ $buktiAppKarung2->temporaryUrl() }}" alt="">
                                                @endif
                                                <div wire:loading wire:target="buktiAppKarung2">
                                                    <span class="text-primary">Uploading ......</span>
                                                </div>
                                ...
                                <div class="card mr-2" style="width: 26rem;">
                                    <div class="col-sm-10">
                                        <div class="card-body">
                                            <label  class="col-sm-8 col-form-label offset-2">Bukti Cek ulang 3</label>
                                                <input wire:model='buktiAppKarung3' accept="image/png, image/jpeg" type="file" id="buktiAppKarung3"  class="ring-a ring-inset ring-gray-300 bg-gray-100 text-gray-900 rounded block mb-4 mt-2  offset-0">
                                                @if($buktiAppKarung3)
                                                    <img class="img-thumbnail rounded float-start offset-2" style="width: 300px; height: 300px" src="{{ $buktiAppKarung3->temporaryUrl() }}" alt="">
                                                @endif
                                                <div wire:loading wire:target="buktiAppKarung3">
                                                    <span class="text-primary">Uploading ......</span>
                                                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    @else --}}
                        <button type="button" class="btn btn-primary" name="submit" wire:click="update()"  wire:confirm="Yakin simpan data?"  >UPLOAD</button>
                    {{-- @endif --}}
