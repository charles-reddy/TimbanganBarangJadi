                ...
                <div class="col">
                    ...
                    <div class="mb-3 row">
                        ...
                        @if ( $isDisabled  == true)
                            ...
                            <input type="text" class="form-control w-50 mt-2" wire:model="sppbNo1" disabled> 
                        @else
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        @if ( $isDisabled  == true)
                            <input type="text" class="form-control w-50 mt-2" wire:model="tiketID" disabled>
                        @else
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10" >
                        @if ( $isDisabled  == true)
                            <input type="text" class="form-control w-50 mt-2" wire:model="itemCode" disabled>
                        @else
                    ...
                    <div class="mb-3 mt-3 row">
                        ...
                        <div class="col-sm-10">
                        @if ( $isDisabled  == true)
                            <input type="text" class="form-control w-50" wire:model="qtyKg" wire:keydown="hitung"  autocomplete="off">
                        @else
                    ...
                    <div class="mb-3 mt-3 row">
                        ...
                        <div class="col-sm-10">
                        @if ( $isDisabled  == true)
                            <input type="text" id="input" class="form-control w-50" wire:model="qtyKarung" wire:keydown="hitung" autocomplete="off">
                        @else
                    ...
                    <div class="mb-3 mt-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="input" class="form-control w-50" wire:model="AwalOpenQtyKarung" autocomplete="off" disabled hidden>
                        </div>
                    </div>
