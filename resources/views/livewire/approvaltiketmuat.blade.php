    ...
    <div class="card-body">
        <div class="card-body table-responsive p-0">
            <div class="my-3 p-3 bg-body rounded shadow-sm"  >
                ...
                <div class="pb-3 pt-3">
                    <input type="text" class="form-control mb-3 w-25" placeholder="Searching ... SPPB" wire:model.live="katakunci">
                </div>
                ...
                <table class="table table-striped table-sortable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>{{ $datatiketmuat->firstItem() + $key }}</td>
                            <td>{{ $value->pendfNo }}</td>
                            <td>{{ $value->sppbNo }}</td>
