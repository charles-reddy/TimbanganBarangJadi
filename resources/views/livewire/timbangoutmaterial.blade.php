                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm5">
                                        ...
                                        <input type="text" class="form-control w-50" wire:model="timbangout"
                                            disabled>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <select class="mb-2 mt-2" wire:model="timbanganoutID">
                                                ...
                                                @foreach ($timbangan as $item)
                                                    <option value="{{ $item->timbanganID }}">{{ $item->timbanganNama }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control w-50" value="{{ $timbangin }}"
                                                disabled>
                                        </div>

                                        <div class="col">
                                            <label for="">Bobot Bersih</label>
                                            <input type="text" class="form-control w-50" value="{{ $netto }}"
                                                disabled>
                                        </div>
            ...
            <table class="table table-striped table-sortable">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-2 sort desc @if ($sortColumn == 'timbanganIn') {{ $sortDirection }} @endif"
                            wire:click="sort('timbanganIn')">Timbangan IN </th>
            ...
            <table class="table table-striped table-sortable">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-1 sort @if ($sortColumn == 'driver') {{ $sortDirection }} @endif"
                            wire:click="sort('driver')">Driver</th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'carID') {{ $sortDirection }} @endif"
                            wire:click="sort('carID')">Car ID</th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'suppName') Supplier $sortDirection }} @endif"
                            wire:click="sort('suppName')">Supplier</th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'itemCode') {{ $sortDirection }} @endif"
                            wire:click="sort('itemCode')">Item Name </th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'timbangin') {{ $sortDirection }} @endif"
                            wire:click="sort('timbangin')"> IN (kg) </th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'timbangout') {{ $sortDirection }} @endif"
                            wire:click="sort('timbangout')"> OUT (kg) </th>
                        <th class="col-md-1 sort desc @if ($sortColumn == 'netto') {{ $sortDirection }} @endif"
                            wire:click="sort('netto')">Netto </th>
                        <th class="col-md-2 sort desc @if ($sortColumn == 'jam_in') {{ $sortDirection }} @endif"
                            wire:click="sort('jam_in')">Date IN </th>
                        <th class="col-md-2 sort desc @if ($sortColumn == 'jam_out') {{ $sortDirection }} @endif"
                            wire:click="sort('jam_out')">Date Out </th>
                        <th class="col-md-2 sort desc @if ($sortColumn == 'timbanganIn') {{ $sortDirection }} @endif"
                            wire:click="sort('timbanganIn')">Timbangan IN </th>
                        <th class="col-md-2 sort desc @if ($sortColumn == 'timbanganOut') {{ $sortDirection }} @endif"
                            wire:click="sort('timbanganOut')">Timbangan OUT </th>
                ...
                <tbody>
                    @foreach ($datascaleout as $keyout => $valueout)
                        <tr>
                            ...
                            <td>
                                @if ($valueout->timbanganInID == 1)
                                    Timbangan 10
                                @elseif ($valueout->timbanganInID == 2)
                                    Timbangan 9
                                @elseif ($valueout->timbanganInID == 3)
                                    Timbangan 8
                                @elseif ($valueout->timbanganInID == 5)
                                    Timbangan 7
                                @endif
                            </td>
                            <td>
                                @if ($valueout->timbanganOutID == 1)
                                    Timbangan 10
                                @elseif ($valueout->timbanganOutID == 2)
                                    Timbangan 9
                                @elseif ($valueout->timbanganOutID == 3)
                                    Timbangan 8
                                @elseif ($valueout->timbanganOutID == 5)
                                    Timbangan 7
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                <a href="/cetakoutm/{{ $valueout->id }} " class="btn btn-primary"
