        ...
        <table class="table table-striped table-sortable">
            <thead>
                <tr>
                    ...
                    <th class="col-md-2 sort desc @if ($sortColumn == 'jam_out') {{ $sortDirection }} @endif"
                        wire:click="sort('jam_out')">Timbangan In </th>
                    <th class="col-md-2 sort desc @if ($sortColumn == 'jam_out') {{ $sortDirection }} @endif"
                        wire:click="sort('jam_out')">Timbangan Out </th>
                </tr>
            </thead>
            <tbody>
                @foreach ($datascaleout as $key => $value)
                    <tr>
                        ...
                        <td>
                            @php
                                if (is_null($value->timbanganID)) {
                                    echo '-';
                                } elseif ($value->timbanganID == 1) {
                                    echo 'Timbangan 10';
                                } elseif ($value->timbanganID == 2) {
                                    echo 'Timbangan 9';
                                } else {
                                    echo 'Timbangan ' . $value->timbanganID;
                                }
                        ...
                        <td>
                            @php
                                if (is_null($value->timbanganoutID)) {
                                    echo '-';
                                } elseif ($value->timbanganoutID == 1) {
                                    echo 'Timbangan 10';
                                } elseif ($value->timbanganoutID == 2) {
                                    echo 'Timbangan 9';
                                } else {
                                    echo 'Timbangan ' . $value->timbanganoutID;
                                }
