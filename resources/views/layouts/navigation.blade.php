<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('createsppb')" :active="request()->routeIs('dashboard')">
                        {{ __('Buat SPPB') }}
                    </x-nav-link>
                </div> --}}
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('inputkarung')" :active="request()->routeIs('dashboard')">
                        {{ __('Input Qty Karung') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('appavgkarung')" :active="request()->routeIs('dashboard')">
                        {{ __('Approval avg Karung ') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('lapsj')" :active="request()->routeIs('dashboard')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('timmasuk')" :active="request()->routeIs('dashboard')">
                {{ __('Timbang Masuk') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('timkeluar')" :active="request()->routeIs('dashboard')">
                {{ __('Timbang Keluar') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('laptim')" :active="request()->routeIs('dashboard')">
