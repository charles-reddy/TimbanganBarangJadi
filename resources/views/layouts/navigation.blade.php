<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden sm:flex space-x-8 sm:items-center sm:ms-10 pt-1">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('multi-product-input-b10')" active="request()->routeIs('dashboard')">
                                {{ __('Input Qty Karung (Multi Produk)') }}
                            </x-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('truktransaction')" :active="request()->routeIs('truktransaction')">
                {{ __('Transaksi') }}
            </x-responsive-nav-link>
        </div>
